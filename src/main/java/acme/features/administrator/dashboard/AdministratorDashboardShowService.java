...
public class AdministratorDashboardShowService implements AbstractShowService<Administrator, AdministratorDashboard>{
	...
	public AdministratorDashboard findOne(final Request<AdministratorDashboard> request) {
		...
		final EnumMap<Status, Integer> numberOfPatronagesByStatus;
		final EnumMap<Status, Double> averageBudgetOfPatronagesByStatus;
		final EnumMap<Status, Double> deviationBudgetOfPatronagesByStatus;
		final EnumMap<Status, Double> minBudgetOfPatronagesByStatus;
		final EnumMap<Status, Double> maxBudgetOfPatronagesByStatus;
		
		numberOfComponents = this.repository.numberOfComponents();
		
		numberOfPatronagesByStatus = new EnumMap<Status, Integer>(Status.class);
		...
		averageBudgetOfPatronagesByStatus = new EnumMap<Status, Double>(Status.class);
		...
		deviationBudgetOfPatronagesByStatus = new EnumMap<Status, Double>(Status.class);
		...
		minBudgetOfPatronagesByStatus = new EnumMap<Status, Double>(Status.class);
		...
		maxBudgetOfPatronagesByStatus = new EnumMap<Status, Double>(Status.class);
