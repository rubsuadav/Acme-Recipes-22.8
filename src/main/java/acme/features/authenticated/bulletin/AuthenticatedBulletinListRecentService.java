...
@Service
public class AuthenticatedBulletinListRecentService implements AbstractListService<Authenticated, Bulletin> {
	...
	public void unbind(final Request<Bulletin> request, final Bulletin entity, final Model model) {
		...
		request.unbind(entity, model, "instantiationMoment", "heading");
	}
