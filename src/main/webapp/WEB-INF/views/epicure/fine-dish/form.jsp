...
<acme:form>
<jstl:if test="${command == 'show'}"><acme:input-money code="chef.item.form.label.conversion" path="conversion" readonly="true"/>
</jstl:if>
...
<jstl:if test="${command != 'create'}">
	...
	<acme:button test="${(status == 'ACCEPTED' || status == 'DENIED') && published == true}" code="chef.fine-dish-report.list.button.create" action="/epicure/memorandum/create?fine-dishId=${id}"/>
</jstl:if>
