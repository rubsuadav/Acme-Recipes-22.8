...
<acme:form>
	...
	<acme:submit test="${command == 'create'  && (status == 'ACCEPTED' || status == 'DENIED')}" code="chef.memorandum.form.button.create" action="/epicure/memorandum/create?fineDishId=${fineDishId}"/>	
