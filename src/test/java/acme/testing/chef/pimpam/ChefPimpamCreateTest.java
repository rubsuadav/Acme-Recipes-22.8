...
public class ChefPimpamCreateTest extends TestHarness{
	...
	@ParameterizedTest
	@CsvFileSource(resources = "/chef/pimpam/create-positive.csv", encoding = "utf-8", numLinesToSkip = 1)
	@Order(10)
	public void positiveTest(final int itemRecordIndex, final int recordIndex, final String code, final String title, final String desciption
		...
		super.checkButtonExists("Pimpam");
