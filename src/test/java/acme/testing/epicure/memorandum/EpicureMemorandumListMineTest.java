...
public class EpicureMemorandumListMineTest extends TestHarness{
	...
	@ParameterizedTest
	@CsvFileSource(resources = "/epicure/memorandum/list-mine.csv", encoding = "utf-8", numLinesToSkip = 1)
	@Order(10)
	...
	public void hackingTest() {
		super.navigate("/epicure/memorandum/list-mine");
